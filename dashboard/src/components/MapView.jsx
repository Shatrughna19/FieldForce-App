...
function createWorkerIcon(worker, isSelected) {
  ...
  const color = colorMap[worker.status] || '#3b82f6'
...
export default function MapView({ workers, selectedWorker, onWorkerClick, isSimulating, onToggleSimulation }) {
  ...
  return (
    <div className="map-section">
      <div className="map-overlay-badge">
        🗺️ Live Map &nbsp;·&nbsp; Delhi NCR &nbsp;·&nbsp; {workers.length} Workers
      </div>
                ...
                <Popup className="worker-popup">
                  <div style={{
                    ...
                    <div style={{ fontSize: '11px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      ...
                      <span>🔋 Battery: {worker.battery}%</span>
                      <span style={{
